...
const Basket: React.FC<BasketProps> = ({ cart }) => {
    return (
        <div className="flex items-center justify-center w-[36px] h-[36px] relative">
            <div className="absolute top-0 right-0">
                <Heading title={cart?.reduce((value, current) => Number(value) + Number(current.quantity), 0)} style={'text-[14px]'} />
            </div>
